...
GC_surface_sulfate_msp.plot(ax=ax,cmap=cmap,vmin = 0,vmax =2,
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A8c_sulphate_GEOS-Chem_DEFRAspatial_Mar-Sep_equalNH3_iccwB.png',bbox_inches='tight')
fig.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A8c_sulphate_GEOS-Chem_DEFRAspatial_Mar-Sep_equalNH3_iccwB.ps', format='ps')
plt.show()
