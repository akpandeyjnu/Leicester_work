...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'sulfate_GEOS-Chem_DEFRAspatial_annualwithoutScotland_iccw.png',bbox_inches='tight')
...
ax.set_title('DEFRA and GEOS-Chem Sulphate (mam)',fontsize=15)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'sulfate_GEOS-Chem_DEFRAspatial_mamwithoutScotland_iccw.png',bbox_inches='tight')
...
ax.set_title('DEFRA and GEOS-Chem Sulphate (jja)',fontsize=15)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'sulfate_GEOS-Chem_DEFRAspatial_jjawithoutScotland_iccw.png',bbox_inches='tight')
...
ax.set_title('DEFRA and GEOS-Chem Sulphate (son)',fontsize=15)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'sulfate_GEOS-Chem_DEFRAspatial_sonwithoutScotland_iccw.png',bbox_inches='tight')
...
ax.set_title('DEFRA and GEOS-Chem Sulphate (djf)',fontsize=15)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'sulfate_GEOS-Chem_DEFRAspatial_djfwithoutScotland_iccw.png',bbox_inches='tight')
