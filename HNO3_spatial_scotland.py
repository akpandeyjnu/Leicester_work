...
#ax.set_title('DEFRA and GEOS-Chem HNO$_3$ (Annual)',fontsize=20)
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'HNO3_GEOS-Chem_DEFRAspatial_annualwithoutScotland_scaleNH3.png',bbox_inches='tight')
...
GC_surface_HNO3_mam.plot(ax=ax,cmap=cmap,vmin = 0,vmax = 2,
								cbar_kwargs={'shrink': 0.0, 
											'pad' : 0.09,
											'label': '',
											'orientation':'horizontal'})

ax.scatter(x=sites_lon, y=sites_lat,c=sites_HNO3_mam,
		facecolors='none',edgecolors='black',linewidths=5,s = 100)
ax.scatter(x=sites_lon, y=sites_lat,c=sites_HNO3_mam,
		cmap=cmap,s = 100,vmin = 0,vmax = 2)
		
ax.set_title('DEFRA and GEOS-Chem HNO$_3$ (mam)',fontsize=15)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'HNO3_GEOS-Chem_DEFRAspatial_mamwithoutScotland_scaleNH3.png',bbox_inches='tight')
...
GC_surface_HNO3_jja.plot(ax=ax,cmap=cmap,vmin = 0,vmax = 2,
								cbar_kwargs={'shrink': 0.0, 
											'pad' : 0.09,
											'label': '',
											'orientation':'horizontal'})

ax.scatter(x=sites_lon, y=sites_lat,c=sites_HNO3_jja,
		facecolors='none',edgecolors='black',linewidths=5,s = 100)
ax.scatter(x=sites_lon, y=sites_lat,c=sites_HNO3_jja,
		cmap=cmap,s = 100,vmin = 0,vmax = 2)
		
ax.set_title('DEFRA and GEOS-Chem HNO$_3$ (jja)',fontsize=15)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'HNO3_GEOS-Chem_DEFRAspatial_jjawithoutScotland_scaleNH3.png',bbox_inches='tight')
...
GC_surface_HNO3_son.plot(ax=ax,cmap=cmap,vmin = 0,vmax = 2,
								cbar_kwargs={'shrink': 0.0, 
											'pad' : 0.09,
											'label': '',
											'orientation':'horizontal'})

ax.scatter(x=sites_lon, y=sites_lat,c=sites_HNO3_son,
		facecolors='none',edgecolors='black',linewidths=5,s = 100)
ax.scatter(x=sites_lon, y=sites_lat,c=sites_HNO3_son,
		cmap=cmap,s = 100,vmin = 0,vmax = 2)
		
ax.set_title('DEFRA and GEOS-Chem HNO$_3$ (son)',fontsize=15)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'HNO3_GEOS-Chem_DEFRAspatial_sonwithoutScotland_scaleNH3.png',bbox_inches='tight')
...
GC_surface_HNO3_djf.plot(ax=ax,cmap=cmap,vmin = 0,vmax = 2,
								cbar_kwargs={'shrink': 0.0, 
											'pad' : 0.09,
											'label': '',
											'orientation':'horizontal'})

ax.scatter(x=sites_lon, y=sites_lat,c=sites_HNO3_djf,
		facecolors='none',edgecolors='black',linewidths=5,s = 100)
ax.scatter(x=sites_lon, y=sites_lat,c=sites_HNO3_djf,
		cmap=cmap,s = 100,vmin = 0,vmax = 2)
		
ax.set_title('DEFRA and GEOS-Chem HNO$_3$ (djf)',fontsize=15)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)                        
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'HNO3_GEOS-Chem_DEFRAspatial_djfwithoutScotland_scaleNH3.png',bbox_inches='tight')
