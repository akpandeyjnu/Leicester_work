...
cbar_ax = fig.add_axes([0.03, 0.02, 0.94, 0.02])  # position and size of the colorbar
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A3_monthly_NAEI_NH3_emissionF_SO2_scaled.png',bbox_inches='tight')
fig.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A3_monthly_NAEI_NH3_emissionF_SO2_scaled.ps', format='ps')
plt.show()
