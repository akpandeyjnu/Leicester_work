...
fig = plt.figure(facecolor='White',figsize=[11,12.9]);pad= 0.5; 
ax = plt.subplot(111);
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A6_map_showing_regional_trends_boxex_so2_scaled.png',bbox_inches='tight')   ##########	
fig.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A6_map_showing_regional_trends_boxex_so2_scaled.ps', format='ps')
plt.show()
