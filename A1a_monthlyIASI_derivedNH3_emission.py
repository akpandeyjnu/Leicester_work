...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A1a_monthly_IASI_derived_NH3emissionF11W_SO2_Scale.png',bbox_inches='tight')
fig.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A1a_monthly_IASI_derived_NH3emissionF11W_SO2_Scale.ps', format='ps')
plt.show()

"""########################### Plot NAEI NH3 Emission #######################################
##########################################################################################

title_listB = 'NAEI NH$_3$ emission (tonnes)'	
title_list1 = 'JAN'
title_list2 = 'FEB'
title_list3 = 'MAR'
title_list4 = 'APR'
...
char = fig.colorbar(colormesh_1,orientation='horizontal',extend='both',cax=cbar_ax,ticks=np.round(np.arange(0,1.01,0.1)*(colorbar_max-colorbar_min)+colorbar_min,2))
char.ax.tick_params(labelsize=20) 
cbar_ax.annotate(r'NAEI NH$_3$ Emission (tonnes)',xy=(0.5,0.9), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.subplots_adjust(left=0.05, bottom=0.07, right=0.98, top=0.97, wspace=0.25, hspace=0.05);
#plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'mon_mean_model_ratio_regrid_without_mask.png',bbox_inches='tight')   ##########	
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'NAEI_NH3_emissionF11W.png',bbox_inches='tight')
plt.show()




########################### Plot NAEI - IASI Difference ###############################
##########################################################################################


title_listC = 'Difference NAEI - IASI NH$_3$ emission (tonnes)'	
title_list1 = 'JAN'
title_list2 = 'FEB'
title_list3 = 'MAR'
title_list4 = 'APR'
...
ax = plt.subplot(3,4,1);
plt.title(title_list1, fontsize = 30, y=1)
colormap=cmap1; colorbar_min=-20;colorbar_max=20## change this accordingly
colormesh_1 = spatial_figure(ax,diff_Jan_NAEI_IASI,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list2, fontsize = 30, y=1)
colormap=cmap1; colorbar_min=-20;colorbar_max=20## change this accordingly
colormesh_1 = spatial_figure(ax,diff_Feb_NAEI_IASI,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list3, fontsize = 30, y=1)
colormap=cmap1; colorbar_min=-20;colorbar_max=20 ## change this accordingly
colormesh_1 = spatial_figure(ax,diff_Mar_NAEI_IASI,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list4, fontsize = 30, y=1)
colormap=cmap1; colorbar_min=-20;colorbar_max=20  ## change this accordingly
colormesh_1 = spatial_figure(ax,diff_Apr_NAEI_IASI,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list5, fontsize = 30, y=1)
colormap=cmap1; colorbar_min=-20;colorbar_max=20  ## change this accordingly
colormesh_1 = spatial_figure(ax,diff_May_NAEI_IASI,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list6, fontsize = 30, y=1)
colormap=cmap1; colorbar_min=-20;colorbar_max=20  ## change this accordingly
colormesh_1 = spatial_figure(ax,diff_Jun_NAEI_IASI,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list7, fontsize = 30, y=1)
colormap=cmap1; colorbar_min=-20;colorbar_max=20  ## change this accordingly
colormesh_1 = spatial_figure(ax,diff_Jul_NAEI_IASI,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list8, fontsize = 30, y=1)
colormap=cmap1; colorbar_min=-20;colorbar_max=20  ## change this accordingly
colormesh_1 = spatial_figure(ax,diff_Aug_NAEI_IASI,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list9, fontsize = 30, y=1)
colormap=cmap1; colorbar_min=-20;colorbar_max=20  ## change this accordingly
colormesh_1 = spatial_figure(ax,diff_Sep_NAEI_IASI,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list10, fontsize = 30, y=1)
colormap=cmap1;colorbar_min=-20;colorbar_max=20 ## change this accordingly
colormesh_1 = spatial_figure(ax,diff_Oct_NAEI_IASI,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list11, fontsize = 30, y=1)
colormap=cmap1; colorbar_min=-20;colorbar_max=20 ## change this accordingly
colormesh_1 = spatial_figure(ax,diff_Nov_NAEI_IASI,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list12, fontsize = 30, y=1)
colormap=cmap1; colorbar_min=-20;colorbar_max=20 ## change this accordingly
colormesh_1 = spatial_figure(ax,diff_Dec_NAEI_IASI,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.subplots_adjust(left=0.05, bottom=0.07, right=0.98, top=0.97, wspace=0.25, hspace=0.05);
#plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'mon_mean_model_ratio_regrid_without_mask.png',bbox_inches='tight')   ##########	
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'NAEI_IASI_difference_emissionF11W.png',bbox_inches='tight')
plt.show()"""
