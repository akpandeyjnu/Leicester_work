...
title_listA = 'IASI  NH$_3$ (molecules/cm$^2$)'	
title_list1 = 'JAN'
title_list2 = 'FEB'
title_list3 = 'MAR'
title_list4 = 'APR'
...
colormesh_1 = spatial_figure(ax,JAN_IASI_column,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('IASI NH$_3$ = {0:.2f}'.format(iasi_derived_NH3_emission_JAN_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
...
colormap=cmap; colorbar_min=0;colorbar_max=10## change this accordingly
colormesh_1 = spatial_figure(ax,FEB_IASI_column,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('IASI NH$_3$ = {0:.2f}'.format(iasi_derived_NH3_emission_FEB_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
colormap=cmap; colorbar_min=0;colorbar_max=10## change this accordingly
colormesh_1 = spatial_figure(ax,MAR_IASI_column,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('IASI NH$_3$ = {0:.2f}'.format(iasi_derived_NH3_emission_MAR_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
colormap=cmap; colorbar_min=0;colorbar_max=10## change this accordingly
colormesh_1 = spatial_figure(ax,APR_IASI_column,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('IASI NH$_3$ = {0:.2f}'.format(iasi_derived_NH3_emission_APR_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')	
...
colormap=cmap; colorbar_min=0;colorbar_max=10## change this accordingly
colormesh_1 = spatial_figure(ax,MAY_IASI_column,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('IASI NH$_3$ = {0:.2f}'.format(iasi_derived_NH3_emission_MAY_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
colormap=cmap; colorbar_min=0;colorbar_max=10## change this accordingly
colormesh_1 = spatial_figure(ax,JUN_IASI_column,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('IASI NH$_3$ = {0:.2f}'.format(iasi_derived_NH3_emission_JUN_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
colormap=cmap; colorbar_min=0;colorbar_max=10## change this accordingly
colormesh_1 = spatial_figure(ax,JUL_IASI_column,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0;colorbar_max=10## change this accordingly
colormesh_1 = spatial_figure(ax,AUG_IASI_column,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('IASI NH$_3$ = {0:.2f}'.format(iasi_derived_NH3_emission_AUG_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
colormap=cmap; colorbar_min=0;colorbar_max=10## change this accordingly
colormesh_1 = spatial_figure(ax,SEP_IASI_column,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('IASI NH$_3$ = {0:.2f}'.format(iasi_derived_NH3_emission_SEP_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
colormap=cmap; colorbar_min=0;colorbar_max=10## change this accordingly
colormesh_1 = spatial_figure(ax,OCT_IASI_column,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('IASI NH$_3$ = {0:.2f}'.format(iasi_derived_NH3_emission_OCT_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')	
...
colormap=cmap; colorbar_min=0;colorbar_max=10## change this accordingly
colormesh_1 = spatial_figure(ax,NOV_IASI_column,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('IASI NH$_3$ = {0:.2f}'.format(iasi_derived_NH3_emission_NOV_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')	
...
colormap=cmap; colorbar_min=0;colorbar_max=10## change this accordingly
colormesh_1 = spatial_figure(ax,DEC_IASI_column,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('IASI NH$_3$ = {0:.2f}'.format(iasi_derived_NH3_emission_DEC_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
cbar_ax.annotate(r'IASI NH$_3$ (10$^{15}$ molecules/cm$^2$)',xy=(0.5,0.9), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'IASI_NH3_X.png',bbox_inches='tight')
plt.show()
...
########################### Plot IASI UNCERTAINTY #######################################
##########################################################################################
title_listB = 'IASI  UNCERTAINTY (molecules/cm$^2$)'	

# Plot Figure 
fig = plt.figure(facecolor='White',figsize=[33,25]);pad= 1.1; 
plt.suptitle(title_listB, fontsize = 35, y=1.001)

ax = plt.subplot(3,4,1);
plt.title(title_list1, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=10## change this accordingly
colormesh_1 = spatial_figure(ax,JAN_IASI_uncertainty,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('NAEI NH$_3$ = {0:.2f}'.format(Jan_naei_nh3_emission_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
plt.title(title_list2, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=10## change this accordingly
colormesh_1 = spatial_figure(ax,FEB_IASI_uncertainty,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)
#ax.annotate('NAEI NH$_3$ = {0:.2f}'.format(Feb_naei_nh3_emission_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
plt.title(title_list3, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=10 ## change this accordingly
colormesh_1 = spatial_figure(ax,MAR_IASI_uncertainty,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('NAEI NH$_3$ = {0:.2f}'.format(Mar_naei_nh3_emission_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
plt.title(title_list4, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=10  ## change this accordingly
colormesh_1 = spatial_figure(ax,APR_IASI_uncertainty,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('NAEI NH$_3$ = {0:.2f}'.format(Apr_naei_nh3_emission_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
plt.title(title_list5, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=10  ## change this accordingly
colormesh_1 = spatial_figure(ax,MAY_IASI_uncertainty,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('NAEI NH$_3$ = {0:.2f}'.format(May_naei_nh3_emission_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
plt.title(title_list6, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=10  ## change this accordingly
colormesh_1 = spatial_figure(ax,JUN_IASI_uncertainty,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('NAEI NH$_3$ = {0:.2f}'.format(Jun_naei_nh3_emission_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
plt.title(title_list7, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=10  ## change this accordingly
colormesh_1 = spatial_figure(ax,JUL_IASI_uncertainty,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('NAEI NH$_3$ = {0:.2f}'.format(Jul_naei_nh3_emission_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
plt.title(title_list8, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=10  ## change this accordingly
colormesh_1 = spatial_figure(ax,AUG_IASI_uncertainty,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('NAEI NH$_3$ = {0:.2f}'.format(Aug_naei_nh3_emission_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
plt.title(title_list9, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=10  ## change this accordingly
colormesh_1 = spatial_figure(ax,SEP_IASI_uncertainty,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('NAEI NH$_3$ = {0:.2f}'.format(Sep_naei_nh3_emission_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
plt.title(title_list10, fontsize = 30, y=1)
colormap=cmap;colorbar_min=0;colorbar_max=10 ## change this accordingly
colormesh_1 = spatial_figure(ax,OCT_IASI_uncertainty,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('NAEI NH$_3$ = {0:.2f}'.format(Oct_naei_nh3_emission_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
plt.title(title_list11, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=10 ## change this accordingly
colormesh_1 = spatial_figure(ax,NOV_IASI_uncertainty,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('NAEI NH$_3$ = {0:.2f}'.format(Nov_naei_nh3_emission_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
plt.title(title_list12, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=10 ## change this accordingly
colormesh_1 = spatial_figure(ax,DEC_IASI_uncertainty,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
#ax.annotate('NAEI NH$_3$ = {0:.2f}'.format(Dec_naei_nh3_emission_UK)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
#		xycoords='axes fraction', textcoords='offset points',
#		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
char = fig.colorbar(colormesh_1,orientation='horizontal',extend='both',cax=cbar_ax,ticks=np.round(np.arange(0,1.01,0.1)*(colorbar_max-colorbar_min)+colorbar_min,2))
char.ax.tick_params(labelsize=20) 
cbar_ax.annotate(r'IASI UNCERTAINTY (10$^{15}$ molecules/cm$^2$)',xy=(0.5,0.9), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.subplots_adjust(left=0.05, bottom=0.07, right=0.98, top=0.97, wspace=0.25, hspace=0.05);
#plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'mon_mean_model_ratio_regrid_without_mask.png',bbox_inches='tight')   ##########	
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'IASI_UNERTAINTY_X.png',bbox_inches='tight')
plt.show()"""
...
########################### Plot IASI UNCERTAINTY in Percentage ###############################
###############################################################################################


title_listC = 'IASI Uncertainty in Percentage'	
...
ax = plt.subplot(3,4,1);
plt.title(title_list1, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=100## change this accordingly
colormesh_1 = spatial_figure(ax,JAN_IASI_uncertaintyP,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list2, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=100## change this accordingly
colormesh_1 = spatial_figure(ax,FEB_IASI_uncertaintyP,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list3, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=100 ## change this accordingly
colormesh_1 = spatial_figure(ax,MAR_IASI_uncertaintyP,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list4, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=100  ## change this accordingly
colormesh_1 = spatial_figure(ax,APR_IASI_uncertaintyP,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list5, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=100  ## change this accordingly
colormesh_1 = spatial_figure(ax,MAY_IASI_uncertaintyP,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list6, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=100  ## change this accordingly
colormesh_1 = spatial_figure(ax,JUN_IASI_uncertaintyP,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list7, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=100  ## change this accordingly
colormesh_1 = spatial_figure(ax,JUL_IASI_uncertaintyP,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list8, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=100  ## change this accordingly
colormesh_1 = spatial_figure(ax,AUG_IASI_uncertaintyP,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list9, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=100  ## change this accordingly
colormesh_1 = spatial_figure(ax,SEP_IASI_uncertaintyP,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
ax = plt.subplot(3,4,10);
plt.title(title_list10, fontsize = 30, y=1)
colormap=cmap;colorbar_min=-100;colorbar_max=100 ## change this accordingly
colormesh_1 = spatial_figure(ax,OCT_IASI_uncertaintyP,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list11, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=100 ## change this accordingly
colormesh_1 = spatial_figure(ax,NOV_IASI_uncertaintyP,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.title(title_list12, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=100 ## change this accordingly
colormesh_1 = spatial_figure(ax,DEC_IASI_uncertaintyP,lon_iasi_uk,lat_iasi_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	

cbar_ax = fig.add_axes([0.10, 0.02, 0.80, 0.03])  # position and size of the colorbar
char = fig.colorbar(colormesh_1,orientation='horizontal',extend='max',cax=cbar_ax,ticks=np.round(np.arange(0,1.01,0.1)*(colorbar_max-colorbar_min)+colorbar_min,2))
char.ax.tick_params(labelsize=20) 
cbar_ax.annotate(r'IASI Uncertainty (%)',xy=(0.5,0.9), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=35)	


plt.subplots_adjust(left=0.05, bottom=0.07, right=0.98, top=0.97, wspace=0.25, hspace=0.05);
#plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'mon_mean_model_ratio_regrid_without_mask.png',bbox_inches='tight')   ##########	
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A1b_IASI_Uncertaintity_P_X_SO2_scaled.png',bbox_inches='tight')
fig.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A1b_IASI_Uncertaintity_P_X_SO2_scaled.ps', format='ps')
plt.show()
