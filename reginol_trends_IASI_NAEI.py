...
def SW_England_ts_mon():
	region_key='SW_England';return_option='mask'
	mask_SW_EnglandA=mask_weight(region_key,lon.copy(),lat.copy(),return_option,reverse=False);
	## weighted average of your data
	SW_England_IASI		= np.nansum(np.nansum(np.multiply(mask_SW_EnglandA,iasi_derived_NH3_emission_year),axis=2),axis=1)
	SW_England_NAEI		= np.nansum(np.nansum(np.multiply(mask_SW_EnglandA,year_naei_nh3_emission),axis=2),axis=1)
	print (SW_England_IASI.shape, 'SW_England_IASI.shape')
	print (SW_England_NAEI.shape, 'SW_England_NAEI.shape')

	return SW_England_IASI,SW_England_NAEI

def E_England_ts_mon():
	region_key1='East_England';return_option='mask'
...
def N_England_ts_mon():
	region_key2='N_England';return_option='mask'
...
def N_Ireland_ts_mon():
	region_key3='N_Ireland';return_option='mask'
...
SW_England_IASI,SW_England_NAEI = SW_England_ts_mon()
...
fig = plt.figure(facecolor='White',figsize=[21,21]);pad= 0.5; 
# plt.suptitle ('Vertical Profile NO$_2$ ', fontsize = 32, y=0.95)

ax = fig.add_subplot(221)
plt.plot(X, SW_England_IASI_mar_sep, c='m',linewidth=5)
plt.plot(X, SW_England_NAEI_mar_sep, c='c',linestyle='-',linewidth=5)
plt.title('SW_England',fontsize = 35, y=1.01)
...
plt.plot(X, East_England_IASI_mar_sep, c='m',linewidth=5)
plt.plot(X, East_England_NAEI_mar_sep, c='c',linestyle='-',linewidth=5)
plt.title('East_England',fontsize = 35, y=1.01)
plt.ylabel('NH$_3$ Emission (Gg)', fontsize = 35, y =0.5)
#plt.xlabel('Months', fontsize = 25, y=0.01)
tick_locs = [1,3,5,7]
tick_lbls = ['Mar','May','Jul','Sep']
...
plt.plot(X, N_England_IASI_mar_sep, c='m',linewidth=5)
plt.plot(X, N_England_NAEI_mar_sep, c='c',linestyle='-',linewidth=5)
...
plt.plot(X, N_Ireland_IASI_mar_sep, c='m',linewidth=5)
plt.plot(X, N_Ireland_NAEI_mar_sep, c='c',linestyle='-',linewidth=5)
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'regional_trends_IASI_NAEI.png',bbox_inches='tight')   ##########	
plt.show()
