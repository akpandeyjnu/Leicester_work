...
def NH3():
	...
	sites_name = df_merge_colB['Site_Name']
	...
	return (GC_surface_ammonia_AM,GC_surface_ammonia_msp,GC_surface_ammonia_mam,GC_surface_ammonia_jja,GC_surface_ammonia_son,GC_surface_ammonia_djf,
		gc_data_ammonia_annual,gc_data_ammonia_msp,gc_data_ammonia_mam,gc_data_ammonia_jja,gc_data_ammonia_son,gc_data_ammonia_djf,
		sites_ammonia_AM,sites_ammonia_msp,sites_ammonia_mam,sites_ammonia_jja,sites_ammonia_son,sites_ammonia_djf)
...
def NH4():
	...
	return(GC_surface_ammonium_AM,GC_surface_ammonium_msp,GC_surface_ammonium_mam,GC_surface_ammonium_jja,GC_surface_ammonium_son,GC_surface_ammonium_djf,
		gc_data_ammonium_annual,gc_data_ammonium_msp,gc_data_ammonium_mam,gc_data_ammonium_jja,gc_data_ammonium_son,gc_data_ammonium_djf,
		sites_ammonium_AM,sites_ammonium_msp,sites_ammonium_mam,sites_ammonium_jja,sites_ammonium_son,sites_ammonium_djf,sites_lon,sites_lat)

GC_surface_ammonia_AM,GC_surface_ammonia_msp,GC_surface_ammonia_mam,GC_surface_ammonia_jja,GC_surface_ammonia_son,GC_surface_ammonia_djf,gc_data_ammonia_annual,gc_data_ammonia_msp,gc_data_ammonia_mam,gc_data_ammonia_jja,gc_data_ammonia_son,gc_data_ammonia_djf,sites_ammonia_AM,sites_ammonia_msp,sites_ammonia_mam,sites_ammonia_jja, sites_ammonia_son,sites_ammonia_djf = NH3()
GC_surface_ammonium_AM,GC_surface_ammonium_msp,GC_surface_ammonium_mam,GC_surface_ammonium_jja,GC_surface_ammonium_son,GC_surface_ammonium_djf,gc_data_ammonium_annual,gc_data_ammonium_msp,gc_data_ammonium_mam,gc_data_ammonium_jja,gc_data_ammonium_son,gc_data_ammonium_djf,sites_ammonium_AM,sites_ammonium_msp,sites_ammonium_mam,sites_ammonium_jja,sites_ammonium_son,sites_ammonium_djf,sites_lon,sites_lat = NH4()

NH3_NH4_annual_sites = sites_ammonia_AM/sites_ammonium_AM
NH3_NH4_msp_sites = sites_ammonia_msp/sites_ammonium_msp
...
NH3_NH4_msp_model = gc_data_ammonia_msp/gc_data_ammonium_msp
...
NHx_msp_GC = GC_surface_ammonia_msp+GC_surface_ammonium_msp
...
NHx_msp_model = gc_data_ammonia_msp + gc_data_ammonium_msp
...
NHx_msp_sites = sites_ammonia_msp + sites_ammonium_msp
...
nmb_msp=100.*((np.nanmean(NHx_msp_model))- np.nanmean(NHx_msp_sites))/np.nanmean(NHx_msp_sites)

#correlation
correlate_Annual=stats.pearsonr(NHx_annual_model,NHx_annual_sites)
#correlate_msp=stats.pearsonr(NHx_msp_model,NHx_msp_sites)
...
NHx_msp_GC.plot(ax=ax,cmap=cmap,vmin = 0,vmax =4,
...
ax.set_title('Geos-Chem & DEFRA NHx (mar-sep)',fontsize=25)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes


"""ax.annotate('Correl_Annual = {0:.2f}'.format(correlate_msp[0]),xy=(0.65,0.75), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=20, color ='r')"""
ax.annotate('NMB Mar-Sep= {0:.2f}'.format(nmb_msp),xy=(0.65,0.85), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A8f_NHx_GEOS-Chem_DEFRAspatial_Mar-Sep_equalNH3_iccw.png',bbox_inches='tight')
fig.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A8f_NHx_GEOS-Chem_DEFRAspatial_Mar-Sep_equalNH3_iccw.ps', format='ps')
plt.show()
