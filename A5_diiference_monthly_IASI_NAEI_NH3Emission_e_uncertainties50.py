...
###############################################################################################
############################    Difference IASI - NAEI   March to September ######################################

diff_mar = Mar_naei_nh3_emission - iasi_derived_NH3_emission_MAR
diff_apr = Apr_naei_nh3_emission - iasi_derived_NH3_emission_APR
diff_may = May_naei_nh3_emission - iasi_derived_NH3_emission_MAY
diff_jun = Jun_naei_nh3_emission - iasi_derived_NH3_emission_JUN
diff_jul = Jul_naei_nh3_emission - iasi_derived_NH3_emission_JUL
diff_aug = Aug_naei_nh3_emission - iasi_derived_NH3_emission_AUG
diff_sep = Sep_naei_nh3_emission - iasi_derived_NH3_emission_SEP
...
# Plot Figure 
fig = plt.figure(facecolor='White',figsize=[25,27]);pad= 1.1; 
...
colormesh_1 = spatial_figure(ax,diff_mar,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
...
colormap=cmap1; colorbar_min=-20;colorbar_max=20## change this accordingly
colormesh_1 = spatial_figure(ax,diff_apr,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap1; colorbar_min=-20;colorbar_max=20  ## change this accordingly
colormesh_1 = spatial_figure(ax,diff_may,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
...
colormap=cmap1; colorbar_min=-20;colorbar_max=20  ## change this accordingly
colormesh_1 = spatial_figure(ax,diff_jun,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap1; colorbar_min=-20;colorbar_max=20  ## change this accordingly
colormesh_1 = spatial_figure(ax,diff_jul,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap1; colorbar_min=-20;colorbar_max=20  ## change this accordingly
colormesh_1 = spatial_figure(ax,diff_aug,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
...
colormap=cmap1; colorbar_min=-20;colorbar_max=20  ## change this accordingly
colormesh_1 = spatial_figure(ax,diff_sep,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	

cbar_ax = fig.add_axes([0.05, 0.02, 0.90, 0.02])  # position and size of the colorbar
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A5_difference_IASI-NAEIemission_uncertainties50_SO2_scaled.png',bbox_inches='tight')
fig.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A5_difference_IASI-NAEIemission_uncertainties50_SO2_scaled.ps', format='ps')
plt.show()
