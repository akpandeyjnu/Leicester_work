...
GC_surface_ammonia_msp.plot(ax=ax,cmap=cmap,vmin = 0,vmax =3,
								cbar_kwargs={'shrink': 0.0, 
											'pad' : 0.09,
											'label': '',
											'orientation':'horizontal'})
											
ax.scatter(x=sites_lon, y=sites_lat,c=sites_ammonia_msp,
		facecolors='none',edgecolors='black',linewidths=5,s = 100)
ax.scatter(x=sites_lon, y=sites_lat,c=sites_ammonia_msp,
		cmap=cmap,s = 100,vmin = 0,vmax = 3)
		
ax.set_title('DEFRA and GEOS-Chem ammonia (mar-sep)',fontsize=15)
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A8b_ammonia_GEOS-Chem_DEFRAspatial_Mar-Sep_equalNH3_scaleSO2B.png',bbox_inches='tight')
fig.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A8b_ammonia_GEOS-Chem_DEFRAspatial_Mar-Sep_equalNH3_scaleSO2B.ps', format='ps')
