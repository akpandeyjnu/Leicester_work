...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A9a_IASI_GC_Column_NH3.png',bbox_inches='tight')
fig.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A9a_IASI_GC_Column_NH3.ps', format='ps')
plt.show()
