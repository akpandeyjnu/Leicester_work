...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'ammonia_GEOS-Chem_DEFRAspatial_annual_iccw.png',bbox_inches='tight')
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'ammonia_GEOS-Chem_DEFRAspatial_mam_iccw.png',bbox_inches='tight')
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'ammonia_GEOS-Chem_DEFRAspatial_jja_iccw.png',bbox_inches='tight')
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'ammonia_GEOS-Chem_DEFRAspatial_son_iccw.png',bbox_inches='tight')
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'ammonia_GEOS-Chem_DEFRAspatial_djf_iccw.png',bbox_inches='tight')
