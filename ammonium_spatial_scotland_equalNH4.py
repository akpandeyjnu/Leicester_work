...
###################################################################################
df_merge_colB = df_merge_colB.drop(df_merge_colB.index[[2,5]])
df_merge_colB.drop(df_merge_colB[df_merge_colB['Lat'] > 56].index, inplace = True) 
#print(df_merge_colB.head(52)) 
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'ammonium_GEOS-Chem_DEFRAspatial_annualwithoutScotland_iccw_equalNH4.png',bbox_inches='tight')
...
ax.set_title('DEFRA and GEOS-Chem ammonium (mam)',fontsize=15)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'ammonium_GEOS-Chem_DEFRAspatial_mam_iccw_equalNH4.png',bbox_inches='tight')
...
ax.set_title('DEFRA and GEOS-Chem ammonium (jja)',fontsize=15)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'ammonium_GEOS-Chem_DEFRAspatial_jja_iccw_equalNH4.png',bbox_inches='tight')
...
ax.set_title('DEFRA and GEOS-Chem ammonium (son)',fontsize=15)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'ammonium_GEOS-Chem_DEFRAspatial_son_iccw_equalNH4.png',bbox_inches='tight')
...
ax.set_title('DEFRA and GEOS-Chem ammonium (djf)',fontsize=15)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'ammonium_GEOS-Chem_DEFRAspatial_djf_iccw_equalNH4.png',bbox_inches='tight')
