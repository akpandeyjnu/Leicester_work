...
path_AerosolMass_50increase = "/data/uptrop/Projects/DEFRA-NH3/GC/geosfp_eu_scale_nh3_emis/AerosolMass/2016/"  # NO2 scale
...
GC_surface_ammonium_msp.plot(ax=ax,cmap=cmap,vmin = 0,vmax =3,
								cbar_kwargs={'shrink': 0.0, 
											'pad' : 0.09,
											'label': '',
											'orientation':'horizontal'})
											
ax.scatter(x=sites_lon, y=sites_lat,c=sites_ammonium_msp,
		facecolors='none',edgecolors='black',linewidths=5,s = 100)
ax.scatter(x=sites_lon, y=sites_lat,c=sites_ammonium_msp,
		cmap=cmap,s = 100,vmin = 0,vmax = 3)
		
ax.set_title('DEFRA and GEOS-Chem ammonium (Mar-Sep)',fontsize=15)
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A8a_ammonium_GEOS-Chem_DEFRAspatial_Mar-Sep_equalNH3_scale_so2.png',bbox_inches='tight')
fig.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A8a_ammonium_GEOS-Chem_DEFRAspatial_Mar-Sep_equalNH3_scale_so2.ps', format='ps')
