...
GC_surface_nitrate_AM.plot(ax=ax,cmap=cmap,vmin = 0,vmax = 5,
...
#ax.set_title('DEFRA and GEOS-Chem Particulate nitrate (Annual)',fontsize=20)
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'nitrate_GEOS-Chem_DEFRAspatial_annualwithoutScotland_iccw.png',bbox_inches='tight')
...
GC_surface_nitrate_mam.plot(ax=ax,cmap=cmap,vmin = 0,vmax =5,
								cbar_kwargs={'shrink': 0.0, 
											'pad' : 0.09,
											'label': '',
											'orientation':'horizontal'})
...
ax.set_title('DEFRA and GEOS-Chem nitrate (mam)',fontsize=15)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'nitrate_GEOS-Chem_DEFRAspatial_mamwithoutScotland_iccw.png',bbox_inches='tight')
...
GC_surface_nitrate_jja.plot(ax=ax,cmap=cmap,vmin = 0,vmax =5,
								cbar_kwargs={'shrink': 0.0, 
											'pad' : 0.09,
											'label': '',
											'orientation':'horizontal'})
...
ax.set_title('DEFRA and GEOS-Chem nitrate (jja)',fontsize=15)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'nitrate_GEOS-Chem_DEFRAspatial_jjawithoutScotland_iccw.png',bbox_inches='tight')
...
GC_surface_nitrate_son.plot(ax=ax,cmap=cmap,vmin = 0,vmax =5,
								cbar_kwargs={'shrink': 0.0, 
											'pad' : 0.09,
											'label': '',
											'orientation':'horizontal'})
...
ax.set_title('DEFRA and GEOS-Chem nitrate (son)',fontsize=15)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'nitrate_GEOS-Chem_DEFRAspatial_sonwithoutScotland_iccw.png',bbox_inches='tight')
...
GC_surface_nitrate_djf.plot(ax=ax,cmap=cmap,vmin = 0,vmax =5,
								cbar_kwargs={'shrink': 0.0, 
											'pad' : 0.09,
											'label': '',
											'orientation':'horizontal'})
...
ax.set_title('DEFRA and GEOS-Chem nitrate (djf)',fontsize=15)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=15) 
colorbar.ax.xaxis.label.set_size(15)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'nitrate_GEOS-Chem_DEFRAspatial_djfwithoutScotland_iccw.png',bbox_inches='tight')
