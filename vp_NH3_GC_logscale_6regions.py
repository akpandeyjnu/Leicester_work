...
def East_England_ts_mon():
	...
	#print (East_England_NH3_GC, 'East_England')
...
def N_Ireland_ts_mon():
	...
	#print (N_Ireland_NH3_GC, 'N_Ireland')
...
fig = plt.figure(facecolor='White',figsize=[20,15]);pad= 0.5; 
...
plt.title('Wales',fontsize = 25, y=1.01)
plt.ylabel('Height (meters)', fontsize = 20, y =0.5)
...
plt.yticks(tick_locs1, tick_lbls1, fontsize = 25, y=1.01)
...
#plt.contourf(wales_NH3_GC_vp, levels, cmap = cm.jet)
#plt.contourf(wales_NH3_GC_vp, cmap = cm.jet)
plt.title('NE_England',fontsize = 25, y=1.01)
plt.ylabel('Height (meters)', fontsize = 25, y =0.5)
plt.xlabel('Months', fontsize = 25, y=0.01)
cb1 = plt.colorbar(aspect = 25, ticks=levels, orientation='vertical',extend='both',fraction=0.1,pad=0.01)
cb1.set_label('NH$_3$  (ppbv)', fontsize = 25)
cb1.ax.set_yticklabels(tick_levels)
...
plt.title('South_England',fontsize = 25, y=1.01)
plt.ylabel('Height (meters)', fontsize = 25, y =0.5)
plt.xlabel('Months', fontsize = 25, y=0.01)
cb1 = plt.colorbar(aspect = 25, ticks=levels, orientation='vertical',extend='both',fraction=0.1,pad=0.01)
cb1.set_label('NH$_3$  (ppbv)', fontsize = 25)
...
#plt.contourf(wales_NH3_GC_vp, cmap = cm.jet)
plt.title('East_England',fontsize = 25, y=1.01)
plt.ylabel('Height (meters)', fontsize = 25, y =0.5)
plt.xlabel('Months', fontsize = 25, y=0.01)
cb1 = plt.colorbar(aspect = 25, ticks=levels, orientation='vertical',extend='both',fraction=0.1,pad=0.01)
cb1.set_label('NH$_3$  (ppbv)', fontsize = 25)
...
#plt.contourf(East_England_NH3_GC_vp, levels, cmap = cm.jet)
#plt.contourf(wales_NH3_GC_vp, cmap = cm.jet)
plt.title('N_Ireland',fontsize = 25, y=1.01)
plt.ylabel('Height (meters)', fontsize = 25, y =0.5)
plt.xlabel('Months', fontsize = 25, y=0.01)
cb1 = plt.colorbar(aspect = 25, ticks=levels, orientation='vertical',extend='both',fraction=0.1,pad=0.01)
cb1.set_label('NH$_3$  (ppbv)', fontsize = 25)
...
#plt.contourf(East_England_NH3_GC_vp, levels, cmap = cm.jet)
#plt.contourf(wales_NH3_GC_vp, cmap = cm.jet)
plt.title('Scotland',fontsize = 25, y=1.01)
plt.ylabel('Height (meters)', fontsize = 25, y =0.5)
plt.xlabel('Months', fontsize = 25, y=0.01)
cb1 = plt.colorbar(aspect = 25, ticks=levels, orientation='vertical',extend='both',fraction=0.1,pad=0.01)
cb1.set_label('NH$_3$  (ppbv)', fontsize = 25)
...
plt.subplots_adjust(left=0.05, bottom=0.07, right=0.98, top=0.97, wspace=0.21, hspace=0.15);
