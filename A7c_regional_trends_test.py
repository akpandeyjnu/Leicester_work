...
### Spatial Quadrature ####
	...
	return mar_sep_uncertaintyP, mar_uncertainty_mask, apr_uncertainty_mask, may_uncertainty_mask, jun_uncertainty_mask, jul_uncertainty_mask, aug_uncertainty_mask,sep_uncertainty_mask, mar_sep_spatial_quadrature,mar_uncertainty_cal, apr_uncertainty_cal, may_uncertainty_cal, jun_uncertainty_cal, jul_uncertainty_cal, aug_uncertainty_cal, sep_uncertainty_cal

	
mar_sep_uncertaintyP, mar_uncertainty_mask, apr_uncertainty_mask, may_uncertainty_mask, jun_uncertainty_mask, jul_uncertainty_mask, aug_uncertainty_mask,sep_uncertainty_mask, mar_sep_spatial_quadrature_error,mar_uncertainty_cal, apr_uncertainty_cal, may_uncertainty_cal, jun_uncertainty_cal, jul_uncertainty_cal, aug_uncertainty_cal, sep_uncertainty_cal = IASI_uncertainty()
...
iasi_derived_NH3_emission_MAR = iasi_derived_NH3_emission_MAR.copy() * mar_uncertainty_mask * quadrature_mask
iasi_derived_NH3_emission_APR = iasi_derived_NH3_emission_APR.copy() * apr_uncertainty_mask * quadrature_mask
iasi_derived_NH3_emission_MAY = iasi_derived_NH3_emission_MAY.copy() * may_uncertainty_mask * quadrature_mask
iasi_derived_NH3_emission_JUN = iasi_derived_NH3_emission_JUN.copy() * jun_uncertainty_mask * quadrature_mask
iasi_derived_NH3_emission_JUL = iasi_derived_NH3_emission_JUL.copy() * jul_uncertainty_mask * quadrature_mask
iasi_derived_NH3_emission_AUG = iasi_derived_NH3_emission_AUG.copy() * aug_uncertainty_mask * quadrature_mask
iasi_derived_NH3_emission_SEP = iasi_derived_NH3_emission_SEP.copy() * sep_uncertainty_mask * quadrature_mask
...
Mar_naei_nh3_emission = Mar_naei_nh3_emission.copy() * mar_uncertainty_mask * quadrature_mask
Apr_naei_nh3_emission = Apr_naei_nh3_emission.copy() * apr_uncertainty_mask * quadrature_mask
May_naei_nh3_emission = May_naei_nh3_emission.copy() * may_uncertainty_mask * quadrature_mask
Jun_naei_nh3_emission = Jun_naei_nh3_emission.copy() * jun_uncertainty_mask * quadrature_mask
Jul_naei_nh3_emission = Jul_naei_nh3_emission.copy() * jul_uncertainty_mask * quadrature_mask
Aug_naei_nh3_emission = Aug_naei_nh3_emission.copy() * aug_uncertainty_mask * quadrature_mask
Sep_naei_nh3_emission = Sep_naei_nh3_emission.copy() * sep_uncertainty_mask * quadrature_mask
...
IASI_error_to_print = (Mar_Sep_iasi_derivedNH3_emission_sum_sum1 * mar_sep_spatial_quadrature_error)/100
NAEI_error_to_print = (Mar_Sep_naei_NH3_emission_sum_sum1 *31)/100

####For time series######

SW_England_IASI		= np.nansum(np.nansum(Mar_Sep_iasi_derivedNH3_emission[:,1:41,55:85],axis=2),axis=1)
print (SW_England_IASI.shape, 'SW_England_IASI.shape')
SW_England_NAEI		= np.nansum(np.nansum(Mar_Sep_naei_NH3_emission[:,1:41,55:85],axis=2),axis=1)

East_England_IASI	= np.nansum(np.nansum(Mar_Sep_iasi_derivedNH3_emission[:,5:41,85:122],axis=2),axis=1)
East_England_NAEI	= np.nansum(np.nansum(Mar_Sep_naei_NH3_emission[:,5:41,85:122],axis=2),axis=1)

N_England_IASI		= np.nansum(np.nansum(Mar_Sep_iasi_derivedNH3_emission[:,41:61,55:105],axis=2),axis=1)
N_England_NAEI		= np.nansum(np.nansum(Mar_Sep_naei_NH3_emission[:,41:61,55:105],axis=2),axis=1)

N_Ireland_IASI		= np.nansum(np.nansum(Mar_Sep_iasi_derivedNH3_emission[:,41:53,21:55],axis=2),axis=1)
N_Ireland_NAEI		= np.nansum(np.nansum(Mar_Sep_naei_NH3_emission[:,41:53,21:55],axis=2),axis=1)


SW_England_IASI_mar_sep = SW_England_IASI/1000
SW_England_NAEI_mar_sep = SW_England_NAEI/1000
East_England_IASI_mar_sep = East_England_IASI/1000
East_England_NAEI_mar_sep = East_England_NAEI/1000
N_England_IASI_mar_sep = N_England_IASI/1000
N_England_NAEI_mar_sep = N_England_NAEI/1000
N_Ireland_IASI_mar_sep = N_Ireland_IASI/1000
N_Ireland_NAEI_mar_sep = N_Ireland_NAEI/1000
...
ax.annotate('IASI NH$_3$ = {0:.2f}'.format(Mar_Sep_iasi_derivedNH3_emission_sum_sum1) +'±'+ "{0:.1f}".format(IASI_error_to_print) +' Gg',xy=(0.41,0.001), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
...
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
ax.annotate('NAEI NH$_3$ = {0:.2f}'.format(Mar_Sep_naei_NH3_emission_sum_sum1)+'±'+ "{0:.1f}".format(NAEI_error_to_print) +' Gg',xy=(0.41,0.001), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'A2_IASI_NAEI_andDifference_NH3emission_Mar_Sep.png',bbox_inches='tight')
fig.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'A2_IASI_NAEI_andDifference_NH3emission_Mar_Sep.ps', format='ps')
plt.show()"""
...
plt.text(6.4, 19.5, str(tot_IASI_SW), fontsize=35, c='m')
plt.text(6.4, 17.5, str(tot_NAEI_SW), fontsize=35, c='c')
...
plt.ylabel('NH$_3$ Emission (Gg)', fontsize = 35, y =0.5)
plt.text(6.4, 19.5, str(tot_IASI_E_Eng), fontsize=35, c='m')
plt.text(6.4, 17.5, str(tot_NAEI_E_Eng), fontsize=35, c='c')
#plt.xlabel('Months', fontsize = 25, y=0.01)
tick_locs = [1,3,5,7]
tick_lbls = ['Mar','May','Jul','Sep']
plt.xticks(tick_locs, tick_lbls, fontsize = 35)
...
plt.ylabel('NH$_3$ Emission (Gg)', fontsize = 35, y =0.5)
plt.text(6.4, 19.5, str(tot_IASI_N_Eng), fontsize=35, c='m')
plt.text(6.4, 17.5, str(tot_NAEI_N_Eng), fontsize=35, c='c')
#plt.xlabel('Months', fontsize = 25, y=0.01)
tick_locs = [1,3,5,7]
tick_lbls = ['Mar','May','Jul','Sep']
plt.xticks(tick_locs, tick_lbls, fontsize = 35)
...
plt.ylabel('NH$_3$ Emission (Gg)', fontsize = 35, y =0.5)
plt.text(6.4, 19.5, str(tot_IASI_N_Ireland), fontsize=35, c='m')
plt.text(6.4, 17.5, str(tot_NAEI_N_Ireland), fontsize=35, c='c')
#plt.xlabel('Months', fontsize = 25, y=0.01)
tick_locs = [1,3,5,7]
tick_lbls = ['Mar','May','Jul','Sep']
plt.xticks(tick_locs, tick_lbls, fontsize = 35)
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A7a_regional_trends_IASI_NAEI_e_error_scale_so2.png',bbox_inches='tight')   ##########	
fig.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A7a_regional_trends_IASI_NAEI_e_error_scale_so2.ps', format='ps')
plt.show()
