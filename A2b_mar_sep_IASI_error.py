...
title_listA = 'MAR - SEP IASI Uncertainty (%)'	
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A2b_mar_sep_IASI_error.png',bbox_inches='tight')
fig.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A2b_mar_sep_IASI_error.ps', format='ps')
plt.show()
