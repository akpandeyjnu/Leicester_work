...
##########################################################################################
title_listA = 'MAR - SEP IASI Derived NH$_3$ Emission \nrelative uncertainty <=50% v2'	
...
# Plot Figure 
fig = plt.figure(facecolor='White',figsize=[11,12.7]);pad= 1.1; 
plt.suptitle(title_listA, fontsize = 35, y=1.02)
...
ax.annotate('IASI NH$_3$ = {0:.2f}'.format(Mar_Sep_iasi_derivedNH3_emission_sum_sum1) +'±'+ "{0:.1f}".format(IASI_error_to_print) +' Gg',xy=(0.39,0.002), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A2a_IASI_NH3emission_Mar_Sep.png',bbox_inches='tight')
fig.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'_A2a_IASI_NH3emission_Mar_Sep.ps', format='ps')
plt.show()
