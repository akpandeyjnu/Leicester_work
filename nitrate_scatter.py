...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'nitrate_GEOS-Chem_DEFRAscatter_annual.png',bbox_inches='tight')
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'nitrate_GEOS-Chem_DEFRAscatter_seasonal.png',bbox_inches='tight')
plt.show()
